                    ...
                    <div class="cicloescolar-index">
                        ...
                        <p>
                            ...
                            <?php 
                                ...
                                ['value'=>Url::to(['cicloescolar/create']),
                        ...
                        <?php
                            $gridColumns = [
                                            ...
                                            [
                                                ...
                                                'pluginEvents' => [
                                                    'switchChange.bootstrapSwitch' => "function(e){
                                                        confirmarVigente($dataProvider->ID);
                                                    }"
                                                ],
                                ...
                                [
                                    ...
                                    'value' => function ($model, $key, $index, $widget) {
                                        return $model->fktipociclo0->nombre;
                                    },
                                    'filterType' => GridView::FILTER_SELECT2,
                                    'filter' => ArrayHelper::map(Tipociclo::find()->orderBy('ID')->asArray()->all(), 'ID', 'nombre'),
                                    'filterWidgetOptions' => [
                               ...
                               /*  [
                                    ...
                                    'buttons' => [
                                        'ver' => function ($url, $dataProvider) {
                                            return Html::button('<i class="fa fa-fw fa-eye"></i>', 
                                                     ['value'=>Url::to(['cicloescolar/view', 'ID'=> $dataProvider->ID]), 
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        ...
                                        ['value'=>Url::to(['cicloescolar/update', 'ID'=> $dataProvider->ID]),
                                        'class' => 'btn btn-outline-primary btn-sm custom_button'
                                        ]);
                                        },
                                    ],
                            ...
                            <?php Pjax::begin(['id'=>'cicloescolar-grid']); ?>

                                <?= GridView::widget([
                                    'id'=>'cicloescolar-grid',
                                    'dataProvider' => $dataProvider,
