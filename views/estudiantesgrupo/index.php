...
/** @var app\models\search\EstudiantesgrupoSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Estudiantes (Grupos)';
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="card-body">
                    ...
                    <div class="estudiantesgrupos-index">
                        ...
                        <p>
                            ...
                            <?php 
                                ...
                                ['value'=>Url::to(['estudiantesgrupo/create']),
                        ...
                        <?php
                            Modal::begin([
                                'title' =>'<h4>Estudiantes (grupos)</h4>',
                                'id'     =>'movi-modal',
                                'size'   =>'modal-lg',
